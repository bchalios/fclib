...
pub struct MachineConfiguration {
    ...
    cpu_template: Option<::models::CpuTemplate>,
...
impl MachineConfiguration {
    ...
    pub fn set_cpu_template(&mut self, cpu_template: ::models::CpuTemplate) {
        self.cpu_template = Some(cpu_template);
    }

    pub fn with_cpu_template(
        mut self,
        cpu_template: ::models::CpuTemplate,
    ) -> MachineConfiguration {
        self.cpu_template = Some(cpu_template);
        self
    }

    pub fn cpu_template(&self) -> Option<&::models::CpuTemplate> {
