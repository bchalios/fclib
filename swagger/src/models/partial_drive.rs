...
pub struct PartialDrive {
    ...
    rate_limiter: Option<::models::RateLimiter>,
}
...
impl PartialDrive {
    ...
    pub fn set_rate_limiter(&mut self, rate_limiter: ::models::RateLimiter) {
        self.rate_limiter = Some(rate_limiter);
    }

    pub fn with_rate_limiter(mut self, rate_limiter: ::models::RateLimiter) -> PartialDrive {
        self.rate_limiter = Some(rate_limiter);
        self
    }

    pub fn rate_limiter(&self) -> Option<&::models::RateLimiter> {
