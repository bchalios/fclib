...
pub struct SnapshotLoadParams {
    ...
    mem_backend: Option<::models::MemoryBackend>,
...
impl SnapshotLoadParams {
    ...
    pub fn set_mem_backend(&mut self, mem_backend: ::models::MemoryBackend) {
        self.mem_backend = Some(mem_backend);
    }

    pub fn with_mem_backend(mut self, mem_backend: ::models::MemoryBackend) -> SnapshotLoadParams {
        self.mem_backend = Some(mem_backend);
        self
    }

    pub fn mem_backend(&self) -> Option<&::models::MemoryBackend> {
